...
<div class="main-content">
  <!-- Your Content Here -->
  <p><a class="show-popup" href="#" data-showpopup="0" >History Loknath</a></p>
  <br>
...
<style>
  * {
  ...
  padding: 2% 5%;
  background: #000; /* fallback */
  background: -moz-linear-gradient(top,  #000 0%, #000 4%, #000 100%);
  background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,#a9e7f9), color-stop(4%,#000000), color-stop(100%,#ffffff));
  background: -webkit-linear-gradient(top,  #fff 0%,white 4%,#fff 100%);
  background: -o-linear-gradient(top,  #1B2062 0%,#1B2062 4%,#1B2062 100%);
  background: -ms-linear-gradient(top,  #1B2062 0%,#1B2062 4%,#1B2062 100%);
  background: linear-gradient(to bottom,  white 0%,white 4%,#1B2062 100%);
  border-radius: 4px;
