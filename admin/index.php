...
<html>
  ...
  <body style="background-image: url(1.jpg);">
    <table style="margin: auto; width: 1000px;box-shadow: 0 0 5px 5px #000;">
      <tr>
        <td><img src="banner02.png" width="1000"/></td>
      </tr>
      <tr>
        <th style="color:#000;height:50px;font-size: 15pt;">
          <div id='cssmenu'>
            <ul>
              ...
              <li class='last'><a href='http://localhost/webproject/index.php'><span>Logout</span></a>
            </ul>
          </div>
      <tr style="height: 500px;background-image: url(1.gif);">
        <td style="vertical-align:top;box-shadow: 0 0 5px 5px #fff;">
          <?php
            if(isset($_GET['menu'])){
                    $menu = $_GET['menu'];
            }else{
